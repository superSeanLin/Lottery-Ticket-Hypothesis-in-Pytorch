...
from pyhessian.utils import group_product, group_add, normalization, get_named_params_grad, get_params_grad, hessian_vector_product, orthnormal
...
class hessian():
    ...
    def __init__(self, model, criterion, data=None, dataloader=None, cuda=True):
        ...
        params, gradsH = get_named_params_grad(self.model)
        self.params = params
    ...
    def trace(self, param_name, maxIter=100, tol=1e-3):
        """
        ...
        for i in range(maxIter):
            ...
            v = [
                ...
                for p in self.params[param_name]
            ]
            ...
            if self.full_dataset:
                ...
                #temp1 = self.gradsH[param_name].size()
                #temp2 = self.params[param_name].size()
                Hv = hessian_vector_product(self.gradsH[param_name], self.params[param_name], v)
